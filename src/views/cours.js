              ...
              <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-lightBlue-500">
                ...
                <blockquote className="relative p-8 mb-4">
                  ...
                  <h4 className="text-xl font-bold text-white">
                   Sujets de discussion de base
                  </h4>
                  <p className="text-md font-light mt-2 text-white">
                  Améliorez vos compétences conversationnelles et gagnez en confiance pour interagir en anglais

Inscrivez-vous pour parcourir les cours gratuitement.
                  </p>
                </blockquote>
              </div>
            </div>
             ...
             <div className="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-32">
              <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-lightBlue-500">
                ...
                <blockquote className="relative p-8 mb-4">
                  ...
                  <p className="text-md font-light mt-2 text-white">
                  Leçons accessibles aux débutants complets
...
Inscrivez-vous pour parcourir les cours gratuitement
             ...
             <div className="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-32">
              <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-lightBlue-500">
                <img
                  alt="..."
                  src="https://stories.freepiklabs.com/storage/4610/Online-Review-amico.svg"
                  className="w-full align-middle rounded-t-lg"
                />
                <blockquote className="relative p-8 mb-4">
                  <svg
                  ...
                  <h4 className="text-xl font-bold text-white">
                    Présentation de recherches académiques
                  </h4>
                  <p className="text-md font-light mt-2 text-white">
                   Apprenez à présenter votre recherche en anglais
        ...
        <div className="container mx-auto overflow-hidden pb-20">
          ...
          <div className="flex flex-wrap items-center pt-32">
            <div className="w-full md:w-6/12 px-4 mr-auto ml-auto mt-32">
              <div className="justify-center flex flex-wrap relative">
                <div className="my-4 w-full lg:w-6/12 px-4">
                  <a
                    href="https://youtu.be/henIVlCPVIY?si=TkEk6jbWE6FCQZdD"
                    target="_blank"
                  >
            ...
            <div className="w-full md:w-4/12 px-12 md:px-4 ml-auto mr-auto mt-48">
              ...
              Gagnez en confiance et maîtrisez les langues conversationnel. Tout le monde y trouvera son bonheur, avec des cours pour tous niveaux de compétence, couvrant tous les domaines, depuis les bases d'une conversation simple jusqu'à l'expression d'opinions parfaitement forgées sur des sujets d'actualité complexes.
              </p>
              <p className="text-lg font-light leading-relaxed mt-4 mb-4 text-blueGray-600">
